...
static void loadCondFormatMap(BrowseDataTableSettings::CondFormatMap& condFormats, QXmlStreamReader& xml, const QString& encoding)
{
    ...
    while(xml.readNext() != QXmlStreamReader::EndElement && xml.name() != name) {
        if (xml.name() == QStringLiteral("column")) {
            ...
            while(xml.readNext() != QXmlStreamReader::EndElement && xml.name() != QStringLiteral("column")) {
                if(xml.name() == QStringLiteral("format")) {
                    QFont font;
...
static void loadBrowseDataTableSettings(BrowseDataTableSettings& settings, sqlb::TablePtr obj, QXmlStreamReader& xml)
{
    ...
    while(xml.readNext() != QXmlStreamReader::EndElement && xml.name() != QStringLiteral("table")) {
        if(xml.name() == QStringLiteral("sort"))
        {
            while(xml.readNext() != QXmlStreamReader::EndElement && xml.name() != QStringLiteral("sort"))
            {
                if(xml.name() == QStringLiteral("column"))
                {
        ...
        } else if(xml.name() == QStringLiteral("column_widths")) {
            while(xml.readNext() != QXmlStreamReader::EndElement && xml.name() != QStringLiteral("column_widths")) {
                if (xml.name() == QStringLiteral("column")) {
                    int index = xml.attributes().value("index").toInt();
        ...
        } else if(xml.name() == QStringLiteral("filter_values")) {
            while(xml.readNext() != QXmlStreamReader::EndElement && xml.name() != QStringLiteral("filter_values")) {
                if (xml.name() == QStringLiteral("column")) {
                    size_t index = xml.attributes().value("index").toUInt();
        ...
        } else if(xml.name() == QStringLiteral("conditional_formats")) {
            loadCondFormatMap(settings.condFormats, xml, settings.encoding);
        } else if(xml.name() == QStringLiteral("row_id_formats")) {
            loadCondFormatMap(settings.rowIdFormats, xml, settings.encoding);
        } else if(xml.name() == QStringLiteral("display_formats")) {
            while(xml.readNext() != QXmlStreamReader::EndElement && xml.name() != QStringLiteral("display_formats")) {
                if (xml.name() == QStringLiteral("column")) {
                    size_t index = xml.attributes().value("index").toUInt();
        ...
        } else if(xml.name() == QStringLiteral("hidden_columns")) {
            while(xml.readNext() != QXmlStreamReader::EndElement && xml.name() != QStringLiteral("hidden_columns")) {
                if (xml.name() == QStringLiteral("column")) {
                    int index = xml.attributes().value("index").toInt();
        ...
        } else if(xml.name() == QStringLiteral("plot_y_axes")) {
            while(xml.readNext() != QXmlStreamReader::EndElement && xml.name() != QStringLiteral("plot_y_axes")) {
                QString y1AxisName;
                QString y2AxisName;
                PlotDock::PlotSettings y1AxisSettings;
                PlotDock::PlotSettings y2AxisSettings;
                if (xml.name() == QStringLiteral("y_axis")) {
                ...
                if (xml.name() == QStringLiteral("y2_axis")) {
        ...
        } else if(xml.name() == QStringLiteral("global_filter")) {
            while(xml.readNext() != QXmlStreamReader::EndElement && xml.name() != QStringLiteral("global_filter"))
            {
                if(xml.name() == QStringLiteral("filter"))
                {
                    QString value = xml.attributes().value("value").toString();
...
MainWindow::LoadAttempResult MainWindow::loadProject(QString filename, bool readOnly)
{
    ...
    if(!filename.isEmpty())
    {
        ...
        if(xml.name() != QStringLiteral("sqlb_project"))
        ...
        while(!xml.atEnd() && !xml.hasError())
        {
            ...
            if(token == QXmlStreamReader::StartElement)
            {
                if(xml.name() == QStringLiteral("db"))
                {
                    ...
                    loadPragmas();
                } else if(xml.name() == QStringLiteral("attached")) {
                    while(xml.readNext() != QXmlStreamReader::EndElement && xml.name() != QStringLiteral("attached"))
                    {
                        if(xml.name() == QStringLiteral("db"))
                        {
                ...
                } else if(xml.name() == QStringLiteral("window")) {
                    // Window settings
                    while(xml.readNext() != QXmlStreamReader::EndElement && xml.name() != QStringLiteral("window"))
                    {
                        if(xml.name() == QStringLiteral("main_tabs")) {
                            // Currently open tabs
                            ...
                            xml.skipCurrentElement();
                        } else if(xml.name() == QStringLiteral("current_tab")) {
                ...
                } else if(xml.name() == QStringLiteral("tab_structure")) {
                    // Database Structure tab settings
                    while(xml.readNext() != QXmlStreamReader::EndElement && xml.name() != QStringLiteral("tab_structure"))
                    {
                        if(xml.name() == QStringLiteral("column_width"))
                        {
                            ...
                            xml.skipCurrentElement();
                        } else if(xml.name() == QStringLiteral("expanded_item")) {
                ...
                } else if(xml.name() == QStringLiteral("tab_browse")) {
                    ...
                    while(xml.readNext() != QXmlStreamReader::EndElement && xml.name() != QStringLiteral("tab_browse"))
                    {
                        if(xml.name() == QStringLiteral("current_table"))
                        {
                            ...
                            if(xml.attributes().value("custom_title").toString() == QStringLiteral("1"))
                                dock->setProperty("custom_title", true);

                            xml.skipCurrentElement();
                        } else if(xml.name() == QStringLiteral("dock_state")) {
                            // Dock state
                            ui->tabBrowsers->restoreState(QByteArray::fromHex(xml.attributes().value("state").toString().toUtf8()));

                            xml.skipCurrentElement();
                        } else if(xml.name() == QStringLiteral("default_encoding")) {
                            // Default text encoding
                            TableBrowser::setDefaultEncoding(xml.attributes().value("codec").toString());
                            xml.skipCurrentElement();
                        } else if(xml.name() == QStringLiteral("browsetable_info")) {
                            ...
                            xml.skipCurrentElement();
                        } else if(xml.name() == QStringLiteral("browse_table_settings")) {

                            while(xml.readNext() != QXmlStreamReader::EndElement && xml.name() != QStringLiteral("browse_table_settings")) {
                ...
                } else if(xml.name() == QStringLiteral("tab_sql")) {
                    // Close all open tabs first
                    for(int i=ui->tabSqlAreas->count()-1;i>=0;i--)
                        closeSqlTab(i, true);

                    // Execute SQL tab data
                    while(xml.readNext() != QXmlStreamReader::EndElement && xml.name() != QStringLiteral("tab_sql"))
                    {
                        if(xml.name() == QStringLiteral("sql"))
                        {
                            // SQL editor tab
